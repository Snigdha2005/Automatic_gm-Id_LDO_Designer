...
def run_ltspice_cir(ltspice_exe, cir_file_path):
    ...
    try:
        ...
        # print(f"[ERROR] Unexpected error while running LTspice: {e}")
        return None
...
# Load Specs
# -----------------------------
def best_gm_id_internal_bandwidth(spec):
    ...
    for gm_id_target in gm_id_vals:
        ...
        # print(phase_margin_sim)
        if total_error < min_error and total_error > 0 and phase_margin_sim >= 45 and Cc > 0 and fmax < fp1_sim:
