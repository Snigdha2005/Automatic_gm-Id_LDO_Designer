...
def plot_trends(gm_id_trend, spec_file_name):
    ...
    # gm values
    # -----------------------------
    save_plot("gm_pass", "gm_pass (S)", "Pass Device gm vs gm/Id", "gm_pass.png")
    save_plot("gm_nmos", "gm_nmos (S)", "Diff Pair gm vs gm/Id", "gm_nmos.png")
    save_plot("gm_pmos", "gm_pmos (S)", "PMOS Load gm vs gm/Id", "gm_pmos.png")
    save_plot("gm_pass_light", "gm_pass_light (S)", "Pass Device gm_light vs gm/Id", "gm_pass_light.png")
...
# Load Specs
# -----------------------------
def best_gm_id_internal(spec_file_name):
    ...
    for gm_id_target in gm_id_vals:
        ...
        ft_fun   = interp1d(gm_id_vals_table, ft_vals, fill_value="extrapolate")
        ...
        id_w = Ilload * 1000 / W
        gm_id_from_idw_fun = interp1d(idw_vals, gm_id_vals_table, fill_value="extrapolate")
